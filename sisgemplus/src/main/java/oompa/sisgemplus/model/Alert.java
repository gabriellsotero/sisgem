...
import oompa.sisgemplus.model.enums.AlertTypes;
...
public class Alert {
	...
	public oompa.sisgemplus.model.enums.AlertTypes getType() {
		return this.typeProperty().get();
	}
	

	public void setType(final oompa.sisgemplus.model.enums.AlertTypes type) {
