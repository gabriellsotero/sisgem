...
public class MainController implements Initializable {
	...
	@FXML	
	private void loadPendingTasks(ActionEvent event)
	{
		Navigator.loadVista("pendingtasks.fxml");
	}
	
	@FXML	
	private void loadPendingApprovalTasks(ActionEvent event)
	{
		Navigator.loadVista("pendingapprovaltasks.fxml");
	}
	
	@FXML	
	private void loadCreateConcept(ActionEvent event)
	{
		Navigator.loadVista("createconcept.fxml");
	}
}